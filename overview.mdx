...
- **[Coding Agent](/coding-agent/overview)** <span style={{ display: 'inline-block', padding: '2px 8px', fontSize: '10px', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '4px', background: 'linear-gradient(90deg, #f59e0b, #ef4444)', color: '#fff', verticalAlign: 'middle', marginLeft: '4px' }}>Flagship</span> — the flagship. Point it at a prompt, a repo, or a template; it ships real pull requests, wires up real integrations, and deploys a working app. Not scaffolding. Not demos.
...
<CardGroup cols={1}>
  <Card title="Coding Agent" icon="rocket" href="/coding-agent/overview">
    <span style={{ display: 'inline-block', padding: '2px 8px', fontSize: '10px', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '4px', background: 'linear-gradient(90deg, #f59e0b, #ef4444)', color: '#fff', marginBottom: '8px' }}>Flagship</span>
  ...
  <Card title="Browser Agents" icon="browser" href="/browser-agents/overview">
    <span style={{ display: 'inline-block', padding: '2px 8px', fontSize: '10px', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', borderRadius: '4px', background: '#10b981', color: '#fff', marginBottom: '8px' }}>New</span>
