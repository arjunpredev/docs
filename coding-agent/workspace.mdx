...
| **Preview** | — | The running app, live in the browser |

<Tip>
  The Plan tabs, Code, and Preview all update in real time as the agent builds — you can watch files appear in the Code view while a sprint runs.
</Tip>
