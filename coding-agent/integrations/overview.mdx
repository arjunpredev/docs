...
<Frame caption="Integrations: OAuth connectors, agent skills, MCP servers, and API keys in one place">
  <img src="/images/product/integrations.jpg" alt="Integrations: OAuth connectors, agent skills, MCP servers, and API keys in one place" />
</Frame>
