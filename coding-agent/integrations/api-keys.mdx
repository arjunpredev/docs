...
If you rotate a key, update it in Integrations, then use **Propagate Environment Variables** to push the new value to existing projects — per project, or all at once.
