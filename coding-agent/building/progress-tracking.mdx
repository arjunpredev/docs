...
<Note>
  Connecting **GitHub** does something different: it creates a repository and keeps your project's code pushed to a `predev` branch. See [Pull Requests](/coding-agent/building/pull-requests) for how code review works.
</Note>
