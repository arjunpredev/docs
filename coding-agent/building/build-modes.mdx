...
| `low` | **Vibe** | Fast direct loop, minimal ceremony — the default feel for quick iterations |
...
<CardGroup cols={2}>
  <Card title="Acceptance Verification" icon="badge-check" href="/coding-agent/building/acceptance-criteria">
