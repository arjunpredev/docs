...
Each pull request shows a verification panel with the result for every acceptance criterion:
...
Admin dashboard hidden from member role     PASSED
```

You review the PR knowing every line was exercised, not just generated.
