...
- pre.dev routes your custom domain to your deployed app
...
- **Subdomains work best** — `app.example.com` maps cleanly with a CNAME; bare domains like `example.com` need a DNS provider that supports CNAME flattening / ALIAS records at the apex
...
2. Confirm removal
3. The routing rule and SSL certificate are cleaned up automatically
