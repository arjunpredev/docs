...
```diff
 # predev/dtc-913 → main · 631a912 · PR #1
...
| `predev/*` | Feature branches for each completed task |
...
<CardGroup cols={2}>
  ...
  <Card title="Roadmap & Tracking" icon="map" href="/coding-agent/building/progress-tracking">
