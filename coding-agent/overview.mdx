...
<CardGroup cols={2}>
  <Card title="Effort levels" icon="gauge-high" href="/coding-agent/building/build-modes">
    Dial how deep each sprint goes — **Vibe** for fast direct edits, **Todo** for task-list loops, **Build** for the full research → code → verify pipeline. Or leave it on Auto.
  </Card>
