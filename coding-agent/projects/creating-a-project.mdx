...
<Tabs>
  <Tab title="Full-Stack Template">
    Start with a curated, pre-configured template. Templates include a recommended tech stack, folder structure, and boilerplate — pre.dev's planning engine builds on top of this foundation.
  ...
  <Tab title="Adaptive">
    Describe your idea in plain English and let pre.dev choose the best architecture. pre.dev's planning engine analyzes your requirements and selects the optimal stack, patterns, and structure.
