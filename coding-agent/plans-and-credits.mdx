...
The workspace tracks what each project has spent, so you can see where credits actually go — which sprints, which phases, which features. Use it to decide where Auto effort is fine and where a cheaper Vibe pass would do.
