...
### Cost
Credits are charged per-inference based on actual token usage: ~10-50 credits for Deep Spec vs ~5-10 for Fast Spec. See [Plans & Credits](/coding-agent/plans-and-credits).
