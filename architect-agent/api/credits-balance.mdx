...
description: "Check the remaining credits balance for your API key."
---
...
| `creditsRemaining` | number | Number of credits remaining for this API key |
...
- **URL:** [https://pre.dev/projects/key](https://pre.dev/projects/key)
- Shows your remaining credits
...
<Card title="Architect API Overview" icon="arrow-left" href="/architect-agent/overview">
