...
class SpecResponse:
    ...
    zippedDocsUrls: Optional[List[ZippedDocsUrl]] = None  # Downloadable doc bundles
    userFlowGraph: Optional[SpecGraph] = None     # User flow nodes + edges
    architectureGraph: Optional[SpecGraph] = None # System architecture nodes + edges
    enrichedTechStack: Optional[List[SpecEnrichedTechStackItem]] = None  # Tech choices with useFor/reason
