---
title: "MCP Setup (Architect API)"
description: "Install the pre.dev MCP server into Cursor, Claude Code, VS Code, or Windsurf so your agent can call fast_spec and deep_spec."
---
...
<CardGroup cols={2}>
  <Card title="fast_spec" icon="bolt">
    **Cost:** ~5-10 credits (variable) | **Speed:** ~1 minute
  ...
  <Card title="deep_spec" icon="microscope">
    **Cost:** ~10-50 credits (variable) | **Speed:** ~3-5 minutes
...
<Info>
  **Check Your Usage:** Visit [pre.dev/projects/key](https://pre.dev/projects/key) to view remaining credits, usage history, and upgrade options.
</Info>
...
<Warning>
  **Out of Credits?**
  ...
  Visit [pre.dev/projects/key](https://pre.dev/projects/key) to upgrade your plan or purchase additional credits.
</Warning>
...
<AccordionGroup>
  <Accordion title="Authentication Failed" icon="triangle-exclamation">
    ...
    - Check that your subscription is active at [pre.dev/projects/key](https://pre.dev/projects/key)
  </Accordion>
