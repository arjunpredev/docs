  ...
  <Step title="Install the MCP Server">
    <Tabs>
      <Tab title="Cursor - One-Click">
        [![Add to Cursor](/images/addtocursor.png)](cursor://anysphere.cursor-deeplink/mcp/install?name=predev&config=eyJ1cmwiOiJodHRwczovL2FwaS5wcmUuZGV2L21jcCIsImhlYWRlcnMiOnsieC1hcGkta2V5IjoiPFlPVVJfQVBJX0tFWT4ifX0%3D)
      ...
      <Tab title="VS Code">
        ...
        ```bash
        code --add-mcp "{\"name\":\"predev\",\"url\":\"https://api.pre.dev/mcp\",\"headers\":{\"x-api-key\":\"YOUR_API_KEY\"}}"
        ```
