...
To take real money, connect a Stripe account you own once from **Integrations → Built-in**, then switch any project from test to live in its Built-in tab. See [go live](/payments/go-live).
