...
```
Content-Type: application/json
x-api-key: ek_prod_d98dc3b4-de9e-4f33-86ac-e784169684c4
```
...
const response = await fetch('http://localhost:3001/fast-spec', {
  method: 'POST',
  headers: {
    'x-api-key': '6308d5be-66a5-4b59-ac98-721c2902751f'
  },
  body: formData
});
```
...
while true; do
  STATUS=$(curl https://api.pre.dev/api/spec-status/$SPEC_ID \
    -H "x-api-key: d98dc3b4-de9e-4f33-86ac-e784169684c4")
...
# Usage
api = ArchitectAPI(api_key="d98dc3b4-de9e-4f33-86ac-e784169684c4")
...
// Synchronous
(async () => {
  const api = new ArchitectAPI('d98dc3b4-de9e-4f33-86ac-e784169684c4');
