...
| `/credits-balance` | GET | Get remaining prototype credits | ✅ |
...
See [Fast Spec](/api-reference/fast-spec) and [Deep Spec](/api-reference/deep-spec) documentation for complete details.
...
|----------|------|------------------|
| Fast Spec | ~5-10 credits | Charged per-inference based on actual token usage |
| Deep Spec | ~10-50 credits | Charged per-inference based on actual token usage |
