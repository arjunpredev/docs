...
|----------|--------|---------|---------------|
| `/api/fast-spec` | POST | Generate quick comprehensive spec | ✅ |
| `/api/deep-spec` | POST | Generate ultra-detailed spec | ✅ |
| `/api/spec-status/:id` | GET | Check async generation status | ✅ |
