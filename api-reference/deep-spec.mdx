---
title: "POST /api/deep-spec - Generate Ultra-Detailed Specifications"
...
- **Generation Time:** ~5-15 minutes (sync) or instant return (async)
...
- **Allocate sufficient time** - Deep specs can take 10-15 minutes
...
### Cost Considerations
- **Higher investment upfront** - 50 generations vs 10 for Fast Spec
...
<Card title="Next: Check Status Endpoint" icon="arrow-right" href="/api-reference/spec-status">
  Monitor async specification generation progress.
</Card>
