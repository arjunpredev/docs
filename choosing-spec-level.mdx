...
**Cost:** Variable (typically ~3-8 credits based on complexity)
...
**Cost:** Variable (typically ~15-40 credits based on complexity)
...
| Cost                     | ~3-8 credits  | ~15-40 credits |
...
### Fast Spec Economics
- **Cost:** ~3-8 credits (variable based on complexity)
...
### Deep Spec Economics
- **Cost:** ~15-40 credits (variable based on complexity)
