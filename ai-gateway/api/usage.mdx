...
The body is OpenRouter's; see the [OpenRouter docs](https://openrouter.ai/docs) for its fields. Use it to inspect the provider, latency, and native token counts behind a specific charge.
