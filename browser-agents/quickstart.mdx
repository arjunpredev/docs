...
<Card title="Get your API key" icon="key" href="https://pre.dev/key" horizontal>
  Sign in once at [pre.dev/key](https://pre.dev/key) and copy your key. Set it as `PREDEV_API_KEY` before running any of the examples below.
</Card>
