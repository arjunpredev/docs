...
<Card title="Get your API key" icon="key" href="https://pre.dev/api-key" horizontal>
  Sign in once at [pre.dev/api-key](https://pre.dev/api-key) and copy your key. Set it as `PREDEV_API_KEY` before running any of the examples below.
</Card>
