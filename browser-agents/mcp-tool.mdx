...
<Steps>
  <Step title="Get your API key">
    <Card title="Get API Key" icon="key" href="https://pre.dev/projects/key">
...
`PREDEV_API_KEY` is all you need. Grab it at [pre.dev/projects/key](https://pre.dev/projects/key) (solo) or from your enterprise dashboard. The same key works for REST and MCP.
