...
Same 100 tasks. Same JSON output schemas. Same uniform pass predicate. Both providers run on their cheapest published tier (pre.dev: `gemini-2.5-flash-lite`; Browser Use: `bu-mini`).
