...
- **Schedules** — recurring runs. Workaround: cron + a 10-line script that calls `browserAgent(...)` on your own scheduler (GitHub Actions, Render cron, Cloudflare Workers cron).
