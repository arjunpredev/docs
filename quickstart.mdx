...
|----------|----------|------|----------------|----------|
| `fast-spec` | Quick prototypes, MVPs | ~3-8 credits | ~30-40 seconds | High-level only |
| `deep-spec` | Production features, complex systems | ~15-40 credits | ~2-3 minutes | Granular breakdown |
