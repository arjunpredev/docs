...
| `/topup` | Buy more credits — opens billing in your browser; a run stopped by the credit wall resumes automatically after you top up |
| `/upgrade` | Upgrade your plan — opens the plan picker in your browser |
